...
export default function Mycart() {
  ...
  const handleUpdateCart = (item, name, value) => {
    ...
    const qtyData = {
      quantity: tempData[item.id - 1][`${name}`],
      skuCode: "123",
    };
  ...
  const printdiv = (elem) => {
    ...
    invoice = invoice.replace(/(h5)/gi, 'h1 className="center"');
    //Logo
    invoice = invoice.replace(
      /(<div className)/gi,
      '<img className="center" src="https://picsum.photos/100/100" alt=""/> <div className'
    );
    invoice = invoice.replace(
    ...
    <>
      ...
      <div style={{ backgroundColor: "azure" }} className="lg:mx-auto">
        <div className="min-w=[100vw] lg:mx-[max(8.34%,16px)]">
          <h1 className={marginLgStyle + marginStyle + " text-2xl font-bold"}>
            My Cart
          </h1>
        </div>
        <div className="section section-mycart lg:flex md:flex:none md:block">
          <CardTemplate
            ...
            width={"min-w-[49.16%]"}
            height={"  "}
            ml={" mx-[max(16px,16px)] lg:ml-[max(8.34%,16px)] "}
            mr={" mr-[20px] mb-[40px] "}
          >
              ...
              userPurhcase.map((item, id) => (
                <div key={id} className="lg:flex lg:inline-block md:block">
                  ...
                  <div
                    style={{ width: "100%" }}
                    className={
                      "pb-[24px] pl-[16px] pr-[24px] " +
                      "flex flex-col justify-between leading-normal mx-auto"
                    }
                  >
                    ...
                    <div className="font-normal text-gray-700 dark:text-gray-400 lg:flex  w-ful">
                      <div className="lg:flex sm:block w-ful">
                        <div className="lg:mr-[16px]">
                          ...
                          <select
                            name="colors"
                            className="lg:w-[7.24vw] w-full h-[54px]"
                            onChange={(e) => {
                              handleUpdateCart(item, "colors", e.target.value);
                            }}
                          >
                        ...
                        <div className="flex justify-between w-full">
                          <div className="mr-[16px]">
                            ...
                            <select
                              ...
                              onChange={(e) => {
                                handleUpdateCart(item, "size", e.target.value);
                              }}
                            >
